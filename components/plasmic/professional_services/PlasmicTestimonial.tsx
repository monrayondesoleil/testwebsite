...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: JitvjQAhtCa6/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__eoyNt)}
      >
        {renderPlasmicSlot({
          defaultContents:
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___0DYac)}
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__kjMqu)}
                displayHeight={"84px"}
              ...
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox___0EpRf)}
              >
                <div
                  className={classNames(projectcss.all, sty.freeBox___0I3ZI)}
                >
                  <h5
                    className={classNames(
                      projectcss.all,
