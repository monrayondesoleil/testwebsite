...
import sty from "./PlasmicHeader.module.css"; // plasmic-import: ISZyIeZUa5a1/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__e98Ti)}>
            <PlasmicLink__
            ...
            >
              <PlasmicImg__
                ...
                loading={"lazy"}
                src={{
                  src: "/plasmic/professional_services/images/logosvg2.svg",
                  fullWidth: 300,
                  fullHeight: 68,
          ...
          <div className={classNames(projectcss.all, sty.column__wkeR)}>
            <div
