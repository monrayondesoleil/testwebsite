...
import sty from "./PlasmicCaseStudiesWraper.module.css"; // plasmic-import: D7A7q8ep5H-w/css
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__iwgR)}
            displayHeight={"auto"}
        ...
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <Button
                className={classNames("__wab_instance", sty.button__wtkf)}
                color={"blackCoffee"}
                submitsForm={true}
              >
                <div
