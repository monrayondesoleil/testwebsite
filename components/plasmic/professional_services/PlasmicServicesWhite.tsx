...
import sty from "./PlasmicServicesWhite.module.css"; // plasmic-import: BkCodqCCsoY2/css

import Icon8Icon from "./icons/PlasmicIcon__Icon8"; // plasmic-import: 7SG8AbDMFh4U/icon
...
function PlasmicServicesWhite__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___22He)}>
        {renderPlasmicSlot({
          defaultContents: (
            <Icon8Icon
              className={classNames(projectcss.all, sty.svg__rgr8N)}
              role={"img"}
            />
          ),
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__u70Az)}
      >
        <h3
